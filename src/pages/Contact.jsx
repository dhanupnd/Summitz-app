        ...
        <section className="w-screen min-h-screen bg-gradient-to-b from-white to-gray-50 flex flex-col">
            ...
            <div className="w-full max-w-5xl mx-auto my-20 px-4">
                <div className="shadow-xl rounded-2xl bg-white overflow-hidden">
                    <div className="bg-[#3559C7] w-full rounded-t-2xl flex items-center justify-center py-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mx-4 my-8">
                        <div className="h-24 flex flex-row bg-white shadow-lg rounded-xl items-center hover:bg-gray-50 transition-all duration-200">
                        ...
                        <div
                            className="h-24 flex flex-row bg-white shadow-lg rounded-xl items-center cursor-pointer hover:bg-gray-50 transition-all duration-200"
                            role="button"
                ...
                <div className="mt-12">
                    <p className="text-gray-900 font-poppins-semibold text-2xl md:text-3xl text-start mb-6">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            {['Apa itu summitz?', 'Bagaimana cara mengikuti open trip yang ada di Summitz?', 'Apa sajakah yang peserta dapatkan dalam paket pendakian?'].map((question) => (
                                <div key={question}>
                                    <div
                                        className="flex justify-between items-center w-full bg-white shadow-md rounded-lg p-4 hover:bg-gray-50 transition-all duration-200 cursor-pointer"
                                        onClick={() => toggleQuestion(question)}
                                        role="button"
                                    >
                                        <p className="text-gray-800 text-base md:text-lg font-medium">{question}</p>
                                    ...
                                    >
                                        <div className="bg-gray-50 shadow-inner rounded-b-lg p-4">
                                            <p className="text-gray-700 text-sm md:text-base font-light">{questions[question]}</p>
                                        </div>
                                    </div>
                                </div>
                            ))}
